  ...
  return (
    <ErpAuthGuard>
      <ErpShell
        ...
        stats={stats}
        actions={<button className="rounded-2xl bg-amber-500 px-4 py-2 text-sm font-semibold text-slate-950 hover:bg-amber-400 transition">Voir agenda</button>}
        ...
        <section id="missions" className="rounded-3xl border border-white/10 bg-slate-950/80 p-6">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-slate-400">Suivi des prochaines commissions et rencontres.</p>
            </div>
          </div>

          <div className="grid gap-4 sm:grid-cols-2">
            {assignments.map((item) => (
              <div key={item.event} className="rounded-3xl border border-white/5 bg-slate-900/80 p-4">
      ...
      <section id="agenda" className="rounded-3xl border border-white/10 bg-slate-950/80 p-6 mt-6">
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-white">Agenda des missions</h3>
          <p className="text-sm text-slate-400">Suivez les prochaines interventions et horaires.</p>
        </div>
        <div className="space-y-4">
          <div className="rounded-3xl border border-white/5 bg-slate-900/80 p-4">
            <p className="text-sm text-slate-300">12 juillet - Match central</p>
            <p className="text-sm text-slate-400">Table de contrôle, validation de feuille.</p>
          </div>
          <div className="rounded-3xl border border-white/5 bg-slate-900/80 p-4">
            <p className="text-sm text-slate-300">20 septembre - Gala II</p>
            <p className="text-sm text-slate-400">Supervision des arbitres ring chief.</p>
          </div>
        </div>
      </section>
    </ErpShell>
